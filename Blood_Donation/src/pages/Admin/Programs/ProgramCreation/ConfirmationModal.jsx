          ...
          <div style={{ marginBottom: 20, padding: 16, backgroundColor: '#fafafa', borderRadius: 6 }}>
            ...
            <div style={{ marginTop: 12 }}>
              ...
              <div style={{ marginTop: 8 }}>
                <img
                  src={imageUrl || 'https://firebasestorage.googleapis.com/v0/b/seventh-dynamo-465214-j3.firebasestorage.app/o/images%2FPlaceholderBloodDrive.jpg?alt=media&token=bdcbe212-ed11-4ba8-83ce-7e594c8d73e6'}
                  alt="Program preview"
                  style={{
                    width: '100%',
                    maxWidth: 200,
